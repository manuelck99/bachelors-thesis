...
NAVIGATOR_COMMAND="python edge_server.py \
 ...
 --clusters-output-path ../data/evaluation/clusters_distributed_1000000_3_edge.json \
 --logging-path ../data/logging/logging_distributed_1000000_3_edge.log \
...
NOVA_COMMAND="python cloud_server.py \
 ...
 --cameras-info-path ../data/road_graph/road_graph_ox_nsl_sim_sc_cameras.pickle \
 --region-partitioning-path ../data/road_graph/region_partitioning_all_3.pickle \
 --clusters-output-path ../data/evaluation/clusters_distributed_1000000_3_cloud.json \
 --logging-path ../data/logging/logging_distributed_1000000_3_cloud.log \
...
# ALL dataset crashes for 3 regions, because of out-of-memory errors
